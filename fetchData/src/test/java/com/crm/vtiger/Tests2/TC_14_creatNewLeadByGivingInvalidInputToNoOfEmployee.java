...
public class TC_14_creatNewLeadByGivingInvalidInputToNoOfEmployee {
	
	@Test
	public void tc_14_creatNewLeadByGivingInvalidInputToNoOfEmployee_Test(XmlTest xml) throws Throwable {
		...
		driver.findElement(By.name("noofemployees")).sendKeys("Abc"+xml.getParameter("noOfEmploy"));
