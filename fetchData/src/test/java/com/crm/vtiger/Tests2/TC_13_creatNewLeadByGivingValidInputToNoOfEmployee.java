...
public class TC_13_creatNewLeadByGivingValidInputToNoOfEmployee {
	
	@Test
	public void tc_13_creatNewLeadByGivingValidInputToNoOfEmployee_Test(XmlTest xml) throws Throwable {
		...
		driver.findElement(By.name("noofemployees")).sendKeys(xml.getParameter("noOfEmploy"));
