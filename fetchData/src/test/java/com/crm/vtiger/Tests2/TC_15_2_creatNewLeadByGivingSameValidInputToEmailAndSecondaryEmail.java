...
public class TC_15_2_creatNewLeadByGivingSameValidInputToEmailAndSecondaryEmail {
	
	@Test
	public void tc_15_2_creatNewLeadByGivingSameValidInputToEmailAndSecondaryEmail_Test(XmlTest xml) throws Throwable {
		...
		driver.findElement(By.name("secondaryemail")).sendKeys(xml.getParameter("email"));
		...
		System.out.println("PASS :: The Lead is not Created");
